                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            ...
                            <li class="link">
                                <a href="classes/GraphicsType.html" data-type="entity-link" >GraphicsType</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="classes/MapLayerProviderOptions.html" data-type="entity-link" >MapLayerProviderOptions</a>
                            </li>
                            <li class="link">
                                <a href="classes/MapTerrainProviderOptions.html" data-type="entity-link" >MapTerrainProviderOptions</a>
                            </li>
                            <li class="link">
